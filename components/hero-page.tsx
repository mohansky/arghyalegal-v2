...
export default function HeroPage({ image, title, className }: HeroPageProps) {
  return (
    <>
      <div className="relative h-[75vh] z-0">
        <div className="relative w-full h-[75vh] z-10 bg-amber-200/10"/>
        <Image
