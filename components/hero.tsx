...
export default function Hero({ image, title, subtitle, btnText, link }: HeroProps) {
  return (
    <>
      <div className="relative top-0 pb-32 h-[100vh] z-0">
        ...
        >
          <h1 className="text-white text-5xl md:text-6xl mb-5 ">
            ...
            {/* Welcome to <span className=" ">{subtitle}Λrgħyä </span> Legal */}
          </h1>
          <Link href={link}>
            <Button size="lg" className="uppercase font-semibold">{btnText}</Button>
          </Link>
        </motion.div>
      </div>
    </>
